...
axios.interceptors.response.use(function (response) {
  ...
  if (response.config.headers["Show-Time"] == undefined) {
 ...
 * 通知
 */
function notity(type, msg = null, title = null) {
    console.log(msg)
...
export default {
	...
	"post": function post(url, data, isShow) {
		return request("post", url, data, undefined, isShow);
	},
